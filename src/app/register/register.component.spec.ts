...
describe("RegisterComponent", () => {
  ...
  it(" should have a h2 (Register)", async(() => {
    let fixture = TestBed.createComponent(RegisterComponent);
    let element = fixture.nativeElement;

    fixture.detectChanges();
    expect(element.querySelector("h2").innerHTML).toBe("Register");
  }));
  ...
  it("Photo field validity .toBeFalsy() .toBeTruthy()", () => {
    let photo = component.registerForm.controls["photo"];
    expect(photo.valid).toBeTruthy();
  });
  it("Are you admin yes field validity .toBeFalsy() .toBeTruthy()", () => {
    let yes = component.registerForm.controls["yes"];
    expect(yes.valid).toBeTruthy();
  });
  it("Are you admin no field validity .toBeFalsy() .toBeTruthy()", () => {
    let no = component.registerForm.controls["no"];
    expect(no.valid).toBeTruthy();
  });
  ...
  it("submitting a form emits a user toBeTruthy() toBeFalsy() toBe()", () => {
    ...
    component.registerForm.controls["photo"].setValue("");
    component.registerForm.controls["yes"].setValue("true");
    component.registerForm.controls["no"].setValue("true");
    ...
    expect(registerUser.photo).toBe("");
    expect(registerUser.yes).toBe("true");
    expect(registerUser.no).toBe("true");
  });
});
